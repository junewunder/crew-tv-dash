...
var pages = ['attendance', 'top-article'];
...
try {
  var _loop = function _loop() {
    ...
    fetch('/pages/' + pageName + '.html').then(function (response) {
      ...
      return (0, _jquery2.default)('.slick-list')[0].style = '';
    });
  };
...
function updateDate() {
  ...
  (0, _jquery2.default)('#nav-date').text(DAYS[date.getDay()] + ', ' + MONTHS[date.getMonth()] + ' ' + date.getDate() + ', ' + date.getFullYear());
  setTimeout(updateDate, ONE_DAY_IN_MS + 10);
}

updateDate();
var date = new Date(Date.now());
var midnightTomorrow = new Date(date.getMonth() + 1 + ' ' + (date.getDate() + 1) + ' ' + date.getFullYear()).valueOf();
setTimeout(updateDate, midnightTomorrow - Date.now());

updateTime();
setInterval(updateTime, 1000);
function updateTime() {
  var $hours = (0, _jquery2.default)('#nav-hours');
  var $minutes = (0, _jquery2.default)('#nav-minutes');
  var $amOrPm = (0, _jquery2.default)('#nav-am-pm');

  var date = new Date(Date.now());
  var hours = date.getHours();
  var minutes = date.getMinutes();

  if (hours !== 0) $hours.text(hours % 13);else $hours.text(12);
